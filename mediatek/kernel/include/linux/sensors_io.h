...
#define CKT_MSENSOR_IOCTL_READ_FACTORY_SENSORDATA  _IOW(MSENSOR, 0x53, int)//jy 2014.6.22
...
/*-------------------jy add-------------------------------------------*/
#define ALSPS_SET_PS_CALI                   _IOR(ALSPS, 0x14, int)
#define ALSPS_GET_PS_CALI                   _IOR(ALSPS, 0x15, int)
#define ALSPS_GET_ID                        _IOR(ALSPS, 0x16, int)
#define ALSPS_RESET_PS                      _IOR(ALSPS, 0x17, int)
/*end*/
