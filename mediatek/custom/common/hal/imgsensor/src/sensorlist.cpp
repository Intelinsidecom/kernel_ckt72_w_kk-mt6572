...
// add ov5645 image sensor, feng.xing@ck-telecom.com, 2014.4.4
    ...
    YUV_INFO(OV5645MIPIQT_SENSOR_ID, SENSOR_DRVNAME_OV5645QT_MIPI_YUV,NULL),
#endif
#if defined(OV5645_AF_MIPI_YUV)
    YUV_INFO(OV5645MIPI_AF_SENSOR_ID, SENSOR_DRVNAME_OV5645_AF_MIPI_YUV,NULL),
#endif
#if defined(OV5645_QT_AF_MIPI_YUV)
    YUV_INFO(OV5645MIPIQT_AF_SENSOR_ID, SENSOR_DRVNAME_OV5645QT_AF_MIPI_YUV,NULL),
#endif
#if defined(HI541_MIPI_YUV)
    YUV_INFO(HI541MIPI_SENSOR_ID, SENSOR_DRVNAME_HI541_MIPI_YUV,NULL),
#endif
// add ov5645 image sensor, feng.xing@ck-telecom.com, 2014.4.25
