...
void OV5645MIPIGetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->FlashLightTimeus = OV5645MIPISensor.strobe;
...
void OV5645MIPI_night_mode(kal_bool enable)
{
	...
	{   /* camera normal mode */                
      ...
      OV5645MIPI_write_cmos_sensor(0x3a15,0x88);	
		  ...
		  {
			OV5645MIPI_write_cmos_sensor(0x3A00,night&0xfb); // 15fps-5fps
...
*
*************************************************************************/
static UINT32 OV5647GZ_OTP_combination_read(void)
...
for(j=0;j<3;j++)
{
    mid = OV5645MIPIYUV_read_cmos_sensor(0x3D05);  
    
    OV5645MIPISENSORDB("##########################################MID = %x\n",mid);	
...
kal_uint32 OV5645MIPI_GetSensorID(kal_uint32 *sensorID)
{
  volatile signed char i;
	...
	//ckt fengyongfei 20130820
	       if (OV5647GZ_OTP_combination_read())
	       {
		  *sensorID =0xffffffff;
...
OV5645MIPI_write_cmos_sensor(0x4837,0x20); 
...
OV5645MIPI_write_cmos_sensor(0x5818,0x0d); 
...
OV5645MIPI_write_cmos_sensor(0x5838,0x04); 
...
OV5645MIPI_write_cmos_sensor(0x5384,0x05); 
OV5645MIPI_write_cmos_sensor(0x5385,0x7c); 
OV5645MIPI_write_cmos_sensor(0x5386,0x81); 
OV5645MIPI_write_cmos_sensor(0x5387,0x86); 
OV5645MIPI_write_cmos_sensor(0x5388,0x7b); 
...
OV5645MIPI_write_cmos_sensor(0x5385,0x7a);  
OV5645MIPI_write_cmos_sensor(0x5386,0x80);   
OV5645MIPI_write_cmos_sensor(0x5387,0x84);   
OV5645MIPI_write_cmos_sensor(0x5388,0x69);  
OV5645MIPI_write_cmos_sensor(0x5389,0x1b);   
OV5645MIPI_write_cmos_sensor(0x538a,0x01);  
OV5645MIPI_write_cmos_sensor(0x538b,0x98);        
OV5645MIPI_write_cmos_sensor(0x5300,0x08);
OV5645MIPI_write_cmos_sensor(0x5301,0x30);   
OV5645MIPI_write_cmos_sensor(0x5302,0x2c); 
OV5645MIPI_write_cmos_sensor(0x5303,0x1c);  
OV5645MIPI_write_cmos_sensor(0x5304,0x08);  
OV5645MIPI_write_cmos_sensor(0x5305,0x30);   
OV5645MIPI_write_cmos_sensor(0x5306,0x1c);
OV5645MIPI_write_cmos_sensor(0x5307,0x2c);   
OV5645MIPI_write_cmos_sensor(0x5309,0x08);  
OV5645MIPI_write_cmos_sensor(0x530a,0x30);   
OV5645MIPI_write_cmos_sensor(0x530b,0x04);  
OV5645MIPI_write_cmos_sensor(0x530c,0x06);        
...
OV5645MIPI_write_cmos_sensor(0x5482,0x0c);//  ;12 
...
OV5645MIPI_write_cmos_sensor(0x5187,0x16);  
OV5645MIPI_write_cmos_sensor(0x5188,0x16);  
OV5645MIPI_write_cmos_sensor(0x5189,0x72);
OV5645MIPI_write_cmos_sensor(0x518a,0x68);
OV5645MIPI_write_cmos_sensor(0x518b,0xf0);
OV5645MIPI_write_cmos_sensor(0x518c,0xb2);
OV5645MIPI_write_cmos_sensor(0x518d,0x50);
OV5645MIPI_write_cmos_sensor(0x518e,0x29);
OV5645MIPI_write_cmos_sensor(0x518f,0x30);
OV5645MIPI_write_cmos_sensor(0x5190,0x50);
OV5645MIPI_write_cmos_sensor(0x5191,0xf8);   
OV5645MIPI_write_cmos_sensor(0x5192,0x04);  
OV5645MIPI_write_cmos_sensor(0x5193,0x70);   
OV5645MIPI_write_cmos_sensor(0x5194,0xf0);   
...
OV5645MIPI_write_cmos_sensor(0x519d,0x82);
OV5645MIPI_write_cmos_sensor(0x519e,0x38);   
OV5645MIPI_write_cmos_sensor(0x5688,0x22);
OV5645MIPI_write_cmos_sensor(0x5689,0x22);
OV5645MIPI_write_cmos_sensor(0x568a,0x42);
OV5645MIPI_write_cmos_sensor(0x568b,0x24);
OV5645MIPI_write_cmos_sensor(0x568c,0x42);
OV5645MIPI_write_cmos_sensor(0x568d,0x24);
OV5645MIPI_write_cmos_sensor(0x568e,0x22);
OV5645MIPI_write_cmos_sensor(0x568f,0x22);      
OV5645MIPI_write_cmos_sensor(0x5025,0x00);        
...
OV5645MIPI_write_cmos_sensor(0x5800,0x1F);     
OV5645MIPI_write_cmos_sensor(0x5801,0x13);   
OV5645MIPI_write_cmos_sensor(0x5802,0x10);   
OV5645MIPI_write_cmos_sensor(0x5803,0x10);   
OV5645MIPI_write_cmos_sensor(0x5804,0x13);   
OV5645MIPI_write_cmos_sensor(0x5805,0x1D);   
...
OV5645MIPI_write_cmos_sensor(0x581E,0x1D);   
...
OV5645MIPI_write_cmos_sensor(0x5823,0x1C);   
OV5645MIPI_write_cmos_sensor(0x5824,0x48);//;47
OV5645MIPI_write_cmos_sensor(0x5825,0x2e);//;2D
OV5645MIPI_write_cmos_sensor(0x5826,0x1E);   
OV5645MIPI_write_cmos_sensor(0x5827,0x1e);//;1D
OV5645MIPI_write_cmos_sensor(0x5828,0x78);//;77
OV5645MIPI_write_cmos_sensor(0x5829,0x1e);//;1D
OV5645MIPI_write_cmos_sensor(0x582A,0x18);//;19
OV5645MIPI_write_cmos_sensor(0x582B,0x16);//;17
OV5645MIPI_write_cmos_sensor(0x582C,0x28);//;29
OV5645MIPI_write_cmos_sensor(0x582D,0x3e);//;3D
OV5645MIPI_write_cmos_sensor(0x582E,0x0c);//;0D
OV5645MIPI_write_cmos_sensor(0x582F,0x24);   
OV5645MIPI_write_cmos_sensor(0x5830,0x20);   
OV5645MIPI_write_cmos_sensor(0x5831,0x22);//;23
OV5645MIPI_write_cmos_sensor(0x5832,0x2c);//;2D
OV5645MIPI_write_cmos_sensor(0x5833,0x1E);   
OV5645MIPI_write_cmos_sensor(0x5834,0x18);//;19
OV5645MIPI_write_cmos_sensor(0x5835,0x16);//;17
OV5645MIPI_write_cmos_sensor(0x5836,0x28);//;29
OV5645MIPI_write_cmos_sensor(0x5837,0x3e);//;3D
OV5645MIPI_write_cmos_sensor(0x5838,0x56);   
OV5645MIPI_write_cmos_sensor(0x5839,0x2e);//;2D
OV5645MIPI_write_cmos_sensor(0x583A,0x1E);   
OV5645MIPI_write_cmos_sensor(0x583B,0x2e);//;2D
OV5645MIPI_write_cmos_sensor(0x583C,0x88);//;87
OV5645MIPI_write_cmos_sensor(0x583D,0xED);   
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3037, 0x13);
	...
	OV5645MIPI_write_cmos_sensor(0x3b00, 0x01);// ckt fengyongfei add 	
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x4202, 0x05);
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x41);//46
	OV5645MIPI_write_cmos_sensor(0x3821, 0x07);//00
...
//ckt fengyongfei 20130814
	OV5645MIPI_write_cmos_sensor(0x3016, 0x02);
	OV5645MIPI_write_cmos_sensor(0x301c, 0x00);
	OV5645MIPI_write_cmos_sensor(0x3b00, 0x83);
	OV5645MIPI_write_cmos_sensor(0x3b07, 0x0a);
	mDELAY(80);
//end
	if(run_test_potten)
	{
...
static void OV5645_FOCUS_OVT_AFC_Touch_AF(UINT32 x,UINT32 y)
{
     ...
     x_tmp = OV5645MIPIYUV_read_cmos_sensor(0x3024);
	   ...
	   spin_lock(&ov5645mipi_drv_lock);
	OV5645MIPISensor.af_xcoordinate = x_tmp;
	OV5645MIPISensor.af_ycoordinate = y_tmp;
	spin_unlock(&ov5645mipi_drv_lock);
...
static void OV5645_FOCUS_OVT_AFC_Get_AF_Status(UINT32 *pFeatureReturnPara32)
{
	...
	*pFeatureReturnPara32 = SENSOR_AF_IDLE;
	...
	state_3028 = OV5645MIPIYUV_read_cmos_sensor(0x3028);//ckt add fyf
	state_3029 = OV5645MIPIYUV_read_cmos_sensor(0x3029);
	OV5645MIPISENSORDB("[OV5645MIPI]enter OV5645_FOCUS_OVT_AFC_Get_AF_Status function:state_3029=%d\n",state_3029);
	mDELAY(1);
	...
	OV5645MIPISENSORDB("[OV5645MIPI]exit OV5645_FOCUS_OVT_AFC_Get_AF_Status function:state_3029=%d\n",state_3029);
}
/*************************************************************************
* FUNCTION
...
BOOL OV5645MIPI_set_param_wb(UINT16 para)
{
	...
	switch (para)
    {
        ...
        case AWB_MODE_DAYLIGHT: //sunny
        	    OV5645MIPI_write_cmos_sensor(0x3212,0x03); 
							OV5645MIPI_set_AWB_mode(KAL_FALSE);                           
							OV5645MIPI_write_cmos_sensor(0x3400,0x05); //0x06 ckt liutao for too much yellow in daylight
							OV5645MIPI_write_cmos_sensor(0x3401,0x30); //0x10 ckt liutao for too much yellow in daylight
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); 
							OV5645MIPI_write_cmos_sensor(0x3404,0x05); //0x04 ckt liutao for too much yellow in daylight
							OV5645MIPI_write_cmos_sensor(0x3405,0x00); //0x48 ckt liutao for too much yellow in daylight
							OV5645MIPI_write_cmos_sensor(0x3212,0x13); 
        	    OV5645MIPI_write_cmos_sensor(0x3212,0xa3);                  
							break;
