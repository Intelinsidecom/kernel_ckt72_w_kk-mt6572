...
inline static int adopt_CAMERA_HW_Control(void *pBuf)
{
	...
	//wenliang add this for check camera's status 20140910 HOPE-419
    checkstatus_video = pSensorCtrl->ScenarioId;
	PK_DBG("pSensorCtrl->ScenarioId = %d,checkstatus_video = %d\n",pSensorCtrl->ScenarioId,checkstatus_video);
	//end
...
{
    device_remove_file(&(pdev->dev),&dev_attr_camera_name);
