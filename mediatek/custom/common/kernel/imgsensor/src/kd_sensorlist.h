...
UINT32 OV5645_AF_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV5645_QT_AF_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
// add hi541 image sensor, feng.xing@ck-telecom.com, 2014.6.23
...
#endif
#if defined(OV5645_QT_MIPI_YUV)
        {OV5645MIPIQT_SENSOR_ID, SENSOR_DRVNAME_OV5645QT_MIPI_YUV, OV5645_QT_MIPI_YUV_SensorInit},
#endif
#if defined(OV5645_AF_MIPI_YUV)
        {OV5645MIPI_AF_SENSOR_ID, SENSOR_DRVNAME_OV5645_AF_MIPI_YUV, OV5645_AF_MIPI_YUV_SensorInit},
#endif
#if defined(OV5645_QT_AF_MIPI_YUV)
        {OV5645MIPIQT_AF_SENSOR_ID, SENSOR_DRVNAME_OV5645QT_AF_MIPI_YUV, OV5645_QT_AF_MIPI_YUV_SensorInit},
#endif
#if defined(HI541_MIPI_YUV)
        {HI541MIPI_SENSOR_ID, SENSOR_DRVNAME_HI541_MIPI_YUV, HI541_MIPI_YUV_SensorInit},
#endif
