...
kal_uint32 gc0312_exposuretime = 0;            //added by leibo
kal_uint8  gc0312_isospeed = AE_ISO_100;        //added by leibo 
...
// added by leibo
kal_uint8 GC0312_get_iso(void)
{
	kal_uint8 iso_temp = 0;
	kal_uint16 regData = 0; 

	GC0312_write_reg(0xfe,0x01);   //write page 1
	regData=GC0312_read_reg(0x14);
	GC0312_write_reg(0xfe,0x00);//write page 0
...
void GC0312_Sensor_Init(void)
{
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x82, 0x1f);//14 
	...
	GC0312_write_cmos_sensor(0x95, 0x77);//65 
	...
	/////////////////////////////////////////////////
	GC0312_write_cmos_sensor(0xfe, 0x00);//
	GC0312_write_cmos_sensor(0xbf, 0x04);//0x02
	GC0312_write_cmos_sensor(0xc0, 0x08);//0x12
	GC0312_write_cmos_sensor(0xc1, 0x14);//0x29
	GC0312_write_cmos_sensor(0xc2, 0x28);//0x42
	GC0312_write_cmos_sensor(0xc3, 0x45);//0x59
	GC0312_write_cmos_sensor(0xc4, 0x60);//0x6e
	GC0312_write_cmos_sensor(0xc5, 0x79);//0x81
	GC0312_write_cmos_sensor(0xc6, 0xA0);//0x9f
	GC0312_write_cmos_sensor(0xc7, 0xB9);//0xb5
	GC0312_write_cmos_sensor(0xc8, 0xCB);//0xc8
	GC0312_write_cmos_sensor(0xc9, 0xD8);//0xd7
	GC0312_write_cmos_sensor(0xca, 0xE2);//0xe1
	GC0312_write_cmos_sensor(0xcb, 0xEB);//0xe9
	GC0312_write_cmos_sensor(0xcc, 0xF1);//0xef
	GC0312_write_cmos_sensor(0xcd, 0xF9);//0xf4
	GC0312_write_cmos_sensor(0xce, 0xFD);//0xfa
	GC0312_write_cmos_sensor(0xcf, 0xFF);//0xff
...
*/
	...
	GC0312_write_cmos_sensor(0xd1, 0x3d); //34
	GC0312_write_cmos_sensor(0xd2, 0x3d);//34
	GC0312_write_cmos_sensor(0xd3, 0x40); //40
	...
	GC0312_write_cmos_sensor(0x21, 0x16); 
	...
	GC0312_write_cmos_sensor(0x6d, 0x00); 
	GC0312_write_cmos_sensor(0x6e, 0xc0); 
	GC0312_write_cmos_sensor(0x6f, 0x25); 
  ...
  GC0312_write_cmos_sensor(0x90, 0xd8);	
  GC0312_write_cmos_sensor(0x91, 0xc8);
  GC0312_write_cmos_sensor(0x92 ,0xea);
  GC0312_write_cmos_sensor(0x93 ,0xd9);
  GC0312_write_cmos_sensor(0x95 ,0xf7);
  GC0312_write_cmos_sensor(0x96 ,0xea);
  GC0312_write_cmos_sensor(0x97 ,0x43);
  GC0312_write_cmos_sensor(0x98 ,0xff);
  GC0312_write_cmos_sensor(0x9a ,0x3d);
  GC0312_write_cmos_sensor(0x9b ,0x0f);
  GC0312_write_cmos_sensor(0x9c ,0x80);
  GC0312_write_cmos_sensor(0x9d ,0x45);
  ...
  GC0312_write_cmos_sensor(0xa6 ,0xc4);
  GC0312_write_cmos_sensor(0xa7 ,0x95);
  GC0312_write_cmos_sensor(0xa9 ,0xc6);
  GC0312_write_cmos_sensor(0xaa ,0x87);
  GC0312_write_cmos_sensor(0xab ,0xab);
  GC0312_write_cmos_sensor(0xac ,0x8f);
  GC0312_write_cmos_sensor(0xae ,0xc4);
  GC0312_write_cmos_sensor(0xaf ,0xab);
  GC0312_write_cmos_sensor(0xb0 ,0xc5);
  GC0312_write_cmos_sensor(0xb1 ,0x98);
  ...
  GC0312_write_cmos_sensor(0x99 ,0x65);
  ...
  GC0312_write_cmos_sensor(0xb8 ,0xc9);
  GC0312_write_cmos_sensor(0xb9 ,0x9e);
	...
	GC0312_write_cmos_sensor(0xc4, 0x50);//40
	GC0312_write_cmos_sensor(0xc5, 0x30);
	GC0312_write_cmos_sensor(0xc6, 0x30);
	GC0312_write_cmos_sensor(0xc7, 0x20);//10
...

{
	...
	gc0312_exposuretime = GC0312_Read_Shutter(); //added by leibo
	gc0312_isospeed = GC0312_get_iso();  //added by leibo
...
void GC0312GetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->AEISOSpeed = gc0312_isospeed;//AE_ISO_100;
    //pExifInfo->AWBMode = GC0312_sensor.wb;
    pExifInfo->CapExposureTime = gc0312_exposuretime; //0;
    pExifInfo->FlashLightTimeus = 0;
    pExifInfo->RealISOValue = gc0312_isospeed;//AE_ISO_100;
}
