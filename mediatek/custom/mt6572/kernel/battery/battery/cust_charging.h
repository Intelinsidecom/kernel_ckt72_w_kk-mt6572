...
//niewenliang modify HOPE-298 20140815
#define MAX_CHARGE_TEMPERATURE_NOTIFY  59
#define MIN_CHARGE_TEMPERATURE_NOTIFY  (-20)
...
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1000_00_MA       //1A
