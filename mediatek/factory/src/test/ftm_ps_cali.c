...
#include "libnvram.h"
#include "../../../custom/ckt72_w_kk/cgen/cfgfileinc/CFG_PRODUCT_INFO_File.h"
#include "../../../custom/ckt72_w_kk/cgen/inc/Custom_NvRam_LID.h"
 ...
 * Functions
 *****************************************************************************/
static int read_write(char *data)
{
	int result;
	F_ID test_nvram_id;
...
*/
/*start modify by jy 2014.01.15 to make ps cali work better*/
static int do_ps_cali(struct lps_priv *lps){
...
/*end modify by jy 2014.01.15 to make ps cali work better*/

/*start added by jy 2014.01.15 to make ps cali work better*/
...
/*end added by jy 2014.01.15 to make ps cali work better*/
/*---------------------------------------------------------------------------*/
...
/*start addded by jy 2014.01.15 to make ps cali work better*/
 		reset_ps_cali(&(dat->lps));
/*end added by jy 2014.01.15 to make ps cali work better*/
		pthread_mutex_lock(&dat->lps.evtmutex);
