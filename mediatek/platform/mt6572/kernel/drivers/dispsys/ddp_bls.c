...
int disp_bls_set_backlight(unsigned int level)
{
    ...
    DISP_MSG("after mapping1, mapped_level: %d\n", mapped_level);

//wenliang add for decrease the level of backlight to 80% 20140915
//HOPE-270 HOPE-792
//	mapped_level = mapped_level*8/10;
//end

    DISP_MSG("after mapping2, mapped_level: %d\n", mapped_level);
